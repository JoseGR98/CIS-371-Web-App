<template>
  <v-container>
    <head>
        ...
        <title>Things and Stuf | Customer Support</title>
    </head>
    <body>

        <header><img class="banner" src="../assets/customerBanner.jpg" alt="Banner with advertisement"></header>
        ...
        <div id="content">
            ...
            <h1>Have a question? Dont worry, we are here to help!</h1>
